...
const MerchantPoiCreate = ({ onCreated }: MerchantPoiCreateProps) => {
  ...
  return (
    ...
    >
      ...
      <Row gutter={12}>
        <Col xs={24} md={12}>
          <Form.Item
            label="Audio Mode"
            name="audioMode"
            rules={[{ required: true, message: "Audio mode is required" }]}
          >
            <Select
              options={[
              ...
              <>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "TTS content is required in TTS mode",
                    },
                  ]}
                >
                  <Input.TextArea
      ...
      <Form.Item label="Pick coordinate on map">
        <PoiMap
          height={320}
